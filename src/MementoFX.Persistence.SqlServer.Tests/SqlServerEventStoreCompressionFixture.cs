...
{
    public class SqlServerEventStoreCompressionFixture
    {
        private readonly IEventDispatcher EventDispatcher;
        private readonly Configuration.Settings Settings;

        public SqlServerEventStoreCompressionFixture()
        {
            this.EventDispatcher = new Mock<IEventDispatcher>().Object;
            this.Settings = new Configuration.Settings(Config.CompressionConnectionString, useCompression: true);
        }
